...
void PWM::all_motor_init(void){
  PWM::servoWrite(LH_Q1, init_Q1);
  PWM::servoWrite(LF_Q1, init_Q1);
  PWM::servoWrite(RF_Q1, init_Q1);
  PWM::servoWrite(RH_Q1, init_Q1);

  PWM::servoWrite(LH_Q2, init_Q2);
  PWM::servoWrite(LF_Q2, init_Q2);
  PWM::servoWrite(RF_Q2, init_Q2);
  PWM::servoWrite(RH_Q2, init_Q2);

  PWM::servoWrite(LH_Q3, init_Q3);
  PWM::servoWrite(LF_Q3, init_Q3);
  PWM::servoWrite(RF_Q3, init_Q3);
  PWM::servoWrite(RH_Q3, init_Q3);
}
